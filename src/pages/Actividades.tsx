      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
        <div className="space-y-12">
          {ACTIVITIES.map((activity, index) => (
            <motion.div
              ...
              className="space-y-4"
            >
              <div className="overflow-hidden rounded-xl border border-border-card shadow-sm cursor-zoom-in">
                <img
                  src={activity.image}
                  alt={activity.title}
                  className="w-full h-auto hover:scale-105 transition-transform duration-500"
                  referrerPolicy="no-referrer"
                  onClick={() => openImage(activity.image, activity.title)}
                />
              </div>
        ...
        <div className="space-y-12">
          <div className="bg-white p-8 rounded-2xl border border-border-card shadow-sm space-y-8">
            ...
            <a
              href="https://www.teniscorvera.com/.cm4all/uproc.php/0/DossierTenis%201.pdf?cdp=a&_=19b19ce5be8"
